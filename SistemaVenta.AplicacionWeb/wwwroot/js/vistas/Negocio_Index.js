...
$("#btnGuardarCambios").click(function () {
    ...
    fetch("/Negocio/GuardarCambios", {
        ...
        .success(function (response) {
            if (response.estado) {
                // Actualizar la imagen con la nueva ruta
                var nuevaRuta = "/ruta/donde/guardar/" + response.data; // Reemplaza "/ruta/donde/guardar/" con la ubicación real
                $("#imgLogo").attr("src", nuevaRuta);
            } else {
